...
public class DensestNeutronCollector extends BlockContainer {
    ...
    public DensestNeutronCollector() {
        ...
        GameRegistry.registerBlock(this, ItemBlockDensestNeutronCollector.class, getUnlocalizedName());
        ReAvaItemList.DensestNeutronCollector.set(new ItemStack(this, 1));
    }

    @SideOnly(Side.CLIENT)
    @Override
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.bottom = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Bottom");
        this.front = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Front");
        this.sideLeft = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_SideLeft");
        this.sideRight = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_SideRight");
        this.side = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Side");
        this.topFacingNorth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Top_North");
        this.topFacingSouth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Top_South");
        this.topFacingWest = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Top_West");
        this.topFacingEast = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DensestNeutronCollector_Top_East");
    }
