...
public class DenserNeutronCollector extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.bottom = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Bottom");
        this.front = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Front");
        this.sideLeft = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_SideLeft");
        this.sideRight = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_SideRight");
        this.side = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Side");
        this.topFacingNorth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Top_North");
        this.topFacingSouth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Top_South");
        this.topFacingWest = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Top_West");
        this.topFacingEast = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenserNeutronCollector_Top_East");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7,
        ...
        if (world.isRemote) {
            ...
            player.openGui(com.reavaritia.ReAvaritia.instance, 0, world, x, y, z);
            return true;
        }
    }
