...
public class DenseNeutronCollector extends BlockContainer {
    ...
    public DenseNeutronCollector() {
        ...
        GameRegistry.registerBlock(this, ItemBlockDenseNeutronCollector.class, getUnlocalizedName());
        ReAvaItemList.DenseNeutronCollector.set(new ItemStack(this, 1));
    }

    @SideOnly(Side.CLIENT)
    @Override
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.bottom = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Bottom");
        this.front = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Front");
        this.sideLeft = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_SideLeft");
        this.sideRight = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_SideRight");
        this.side = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Side");
        this.topFacingNorth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Top_North");
        this.topFacingSouth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Top_South");
        this.topFacingWest = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Top_West");
        this.topFacingEast = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "DenseNeutronCollector_Top_East");
    }
