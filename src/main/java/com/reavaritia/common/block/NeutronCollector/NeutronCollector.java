...
public class NeutronCollector extends BlockContainer {
    ...
    public NeutronCollector() {
        ...
        ReAvaItemList.NeutronCollector.set(new ItemStack(this, 1));
    }

    @SideOnly(Side.CLIENT)
    @Override
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.bottom = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Bottom");
        this.front = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Front");
        this.sideLeft = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_SideLeft");
        this.sideRight = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_SideRight");
        this.side = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Side");
        this.topFacingNorth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Top_North");
        this.topFacingSouth = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Top_South");
        this.topFacingWest = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Top_West");
        this.topFacingEast = iconRegister.registerIcon(RESOURCE_ROOT_ID + ":" + "NeutronCollector_Top_East");
    }
