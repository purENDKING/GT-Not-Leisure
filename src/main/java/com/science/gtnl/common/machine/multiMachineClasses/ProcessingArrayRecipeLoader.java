...
public class ProcessingArrayRecipeLoader {
    ...
    public static void registerDefaultGregtechMaps() {
        ...
        ProcessingArrayManager.addSoundResourceToPA("simplewasher.01", SoundResource.NONE);
        // Mass Fabricator
        ProcessingArrayManager.addRecipeMapToPA("basicmachine.massfab", RecipeMaps.massFabFakeRecipes);
        ProcessingArrayManager.addSoundResourceToPA("basicmachine.massfab", SoundResource.NONE);
        // Replicator
        ProcessingArrayManager.addRecipeMapToPA("basicmachine.replicator", RecipeMaps.replicatorRecipes);
        ProcessingArrayManager.addSoundResourceToPA("basicmachine.replicator", SoundResource.NONE);
