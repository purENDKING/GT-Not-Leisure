...
public class LuvKuangBiaoOneGiantNuclearFusionReactor
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("KuangBiaoOneGiantNuclearFusionReactorRecipeType"))
            ...
            .addInfo(StatCollector.translateToLocal("Tooltip_KuangBiaoOneGiantNuclearFusionReactor_04") + "160M EU")
            .addInfo(StatCollector.translateToLocal("Tooltip_LuvKuangBiaoOneGiantNuclearFusionReactor_00"))
