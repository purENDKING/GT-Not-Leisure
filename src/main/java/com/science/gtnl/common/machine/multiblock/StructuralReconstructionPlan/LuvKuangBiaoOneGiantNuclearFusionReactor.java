...
public class LuvKuangBiaoOneGiantNuclearFusionReactor
    ...
    public static final int CASING_INDEX = GTUtility.getCasingTextureIndex(GregTechAPI.sBlockCasings1, 6);
    ...
    public LuvKuangBiaoOneGiantNuclearFusionReactor(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public LuvKuangBiaoOneGiantNuclearFusionReactor(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new LuvKuangBiaoOneGiantNuclearFusionReactor(this.mName);
    }
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.KuangBiaoOneGiantNuclearFusionReactorRecipeType)
            ...
            .addInputBus(TextLocalization.Tooltip_LuvKuangBiaoOneGiantNuclearFusionReactor_Casing)
            .addOutputBus(TextLocalization.Tooltip_LuvKuangBiaoOneGiantNuclearFusionReactor_Casing)
            .addEnergyHatch(TextLocalization.Tooltip_LuvKuangBiaoOneGiantNuclearFusionReactor_Casing)
            .addMaintenanceHatch(TextLocalization.Tooltip_LuvKuangBiaoOneGiantNuclearFusionReactor_Casing)
            .toolTipFinisher();
        return tt;
    }
    ...
    public ProcessingLogic createProcessingLogic() {
        return new ProcessingLogic() {
            ...
            protected CheckRecipeResult validateRecipe(@NotNull GTRecipe recipe) {
                ...
                LuvKuangBiaoOneGiantNuclearFusionReactor.this.lastRecipe = recipe;
    ...
    @Override
    public IStructureDefinition<LuvKuangBiaoOneGiantNuclearFusionReactor> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<LuvKuangBiaoOneGiantNuclearFusionReactor>builder()
