        ...
        if (STRUCTURE_DEFINITION == null) {
            ...
            STRUCTURE_DEFINITION = StructureDefinition.<PrimitiveDistillationTower>builder()
                ...
                .addElement(
                    'A',
                    ofChain(
                        buildSteamBigInput(PrimitiveDistillationTower.class).casingIndex(getCasingTextureID())
                            .dot(1)
                            .build(),
                        buildSteamInput(PrimitiveDistillationTower.class).casingIndex(getCasingTextureID())
                            .dot(1)
                            .build(),
                        buildHatchAdder(PrimitiveDistillationTower.class).casingIndex(getCasingTextureID())
                            ...
                            .atLeast(
                                ...
                                InputHatch)
                            .buildAndChain(
                                onElementPass(x -> ++x.tCountCasing, ofBlock(GregTechAPI.sBlockCasings3, 14)))))
                .addElement(
                    'B',
                    ofChain(
                        onElementPass(
