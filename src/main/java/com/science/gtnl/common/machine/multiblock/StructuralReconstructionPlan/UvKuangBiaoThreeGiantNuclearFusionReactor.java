...
public class UvKuangBiaoThreeGiantNuclearFusionReactor
    extends GTMMultiMachineBase<UvKuangBiaoThreeGiantNuclearFusionReactor> implements ISurvivalConstructable {
    ...
    public UvKuangBiaoThreeGiantNuclearFusionReactor(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new UvKuangBiaoThreeGiantNuclearFusionReactor(this.mName);
    }
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.KuangBiaoOneGiantNuclearFusionReactorRecipeType)
            ...
            .addInfo(TextLocalization.Tooltip_KuangBiaoOneGiantNuclearFusionReactor_04 + "640M EU")
            .addInfo(TextLocalization.Tooltip_UvKuangBiaoThreeGiantNuclearFusionReactor_00)
            ...
            .addInputBus(TextLocalization.Tooltip_UvKuangBiaoThreeGiantNuclearFusionReactor_Casing)
            .addOutputBus(TextLocalization.Tooltip_UvKuangBiaoThreeGiantNuclearFusionReactor_Casing)
            .addEnergyHatch(TextLocalization.Tooltip_UvKuangBiaoThreeGiantNuclearFusionReactor_Casing)
            .addMaintenanceHatch(TextLocalization.Tooltip_UvKuangBiaoThreeGiantNuclearFusionReactor_Casing)
            .toolTipFinisher();
        return tt;
    }
    ...
    public ProcessingLogic createProcessingLogic() {
        return new ProcessingLogic() {
            ...
            protected CheckRecipeResult validateRecipe(@NotNull GTRecipe recipe) {
                UvKuangBiaoThreeGiantNuclearFusionReactor.this.lastRecipe = null;
                if (!mRunningOnLoad) {
                    if (recipe.mSpecialValue > mEUStore) {
                        return CheckRecipeResultRegistry.insufficientStartupPower(recipe.mSpecialValue);
                    }
                    if (recipe.mEUt > GTValues.V[9]) {
                        return CheckRecipeResultRegistry.insufficientPower(recipe.mEUt);
                    }
                }
                UvKuangBiaoThreeGiantNuclearFusionReactor.this.lastRecipe = recipe;
    ...
    @Override
    public IStructureDefinition<UvKuangBiaoThreeGiantNuclearFusionReactor> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<UvKuangBiaoThreeGiantNuclearFusionReactor>builder()
                ...
                .addElement('I', ofBlock(Loaders.compactFusionCoil, 2))
