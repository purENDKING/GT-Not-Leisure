...
public class UvKuangBiaoThreeGiantNuclearFusionReactor
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("KuangBiaoOneGiantNuclearFusionReactorRecipeType"))
            ...
            .addInfo(StatCollector.translateToLocal("Tooltip_KuangBiaoOneGiantNuclearFusionReactor_04") + "640M EU")
            .addInfo(StatCollector.translateToLocal("Tooltip_UvKuangBiaoThreeGiantNuclearFusionReactor_00"))
